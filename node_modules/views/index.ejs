...
<html>
  <head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        form input { border-style: solid; border-width: 1px; padding: 10px; width: 85%; margin-right: .5%; color:white; background:black;}
  ...
  <body>
    ...
    <form action="/" method="POST" id="chatForm">
      <input id="txt" autocomplete="off" autofocus="on" oninput="isTyping()" placeholder="Type your message here..." /><button id="send" disabled>Send</button>
    </form>
    <script>
